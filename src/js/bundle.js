...
/* harmony import */ var _parts_tabDec_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parts/tabDec.js */ "./src/js/parts/tabDec.js");
/* harmony import */ var _parts_tabGlaz_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parts/tabGlaz.js */ "./src/js/parts/tabGlaz.js");
/* harmony import */ var _parts_calc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parts/calc.js */ "./src/js/parts/calc.js");
/* harmony import */ var _parts_foto_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parts/foto.js */ "./src/js/parts/foto.js");
/* harmony import */ var _parts_timer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/timer.js */ "./src/js/parts/timer.js");
/* harmony import */ var _parts_modal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parts/modal.js */ "./src/js/parts/modal.js");
/* harmony import */ var _parts_form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parts/form.js */ "./src/js/parts/form.js");
...
Object(_parts_calc_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_parts_foto_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_parts_tabDec_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
Object(_parts_tabGlaz_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
Object(_parts_timer_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_parts_modal_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_parts_form_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
function calc() {
  var priceBtn = document.querySelectorAll('.glazing_price_btn '),
  ...
  var hideCalcContent = function hideCalcContent(a) {
    for (var i = a; i < popupCalcImg.length; i++) {
  ...
  balconIcons.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains('balcon_icons_icon')) {
      for (var i = 0; i < balconIconsIcon.length; i++) {
  ...
  var checkCalc = function checkCalc() {
  ...
  checkCalc();
  var buttonProfile = document.getElementsByClassName('popup_calc_profile_button')[0],
  ...
  var popupCalcForm = document.querySelector('#popup-calc__form'),
  ...
  function sendForm(item) {
    item.addEventListener('submit', function (event) {
      ...
      postData(formData).then(function () {
        return statusMess.innerHTML = mess.loading;
      }).then(function () {
        return statusMess.innerHTML = mess.success;
      }).catch(function () {
        return statusMess.innerHTML = mess.failure;
      }).then(function () {
        for (var j = 0; j < popupCalcFormInput.length; j++) {
...
function form() {
  ...
  var myForm = document.querySelectorAll('.myForm'),
...
function foto() {
  var photos = document.querySelectorAll(".photo_min"),
  ...
  photos.forEach(function (photo, index) {
    photo.addEventListener("click", function (event) {
      event.preventDefault();
      bigPhoto.innerHTML = "<img src='img/our_works/big_img/".concat(index + 1, ".png'>");
  ...
  bigPhoto.addEventListener("click", function (event) {
    if (event.target.classList.contains("big_photo")) {
      ...
      var photo = parseInt(bigPhoto.innerHTML.replace(/\D/g, "")),
          next = photo + 1;

      if (next <= photos.length) {
        bigPhoto.innerHTML = "<img src='img/our_works/big_img/".concat(next, ".png'>");
      } else {
...
function modal() {
  var btnEngineer = document.querySelector(".popup_engineer_btn"),
      ...
      callBtn = document.querySelectorAll(".phone_link"); //time();

  modalEngineer.addEventListener("click", function (event) {
    if (event.target.matches("div.popup_engineer") || event.target.classList.contains("popup_close") || event.target.matches("strong")) {
  ...
  modalPopup.addEventListener("click", function (event) {
    if (event.target.matches("div.popup") || event.target.classList.contains("popup_close") || event.target.matches("strong")) {
...
/* harmony default export */ __webpack_exports__["default"] = (tabDec);

/***/ }),

/***/ "./src/js/parts/tabGlaz.js":
/*!*********************************!*\
  !*** ./src/js/parts/tabGlaz.js ***!
  \*********************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (tabGlaz);
...
function timer() {
  ...
  function setClock(id, endtime) {
    ...
    function updateClock() {
      ...
      if (t.days.length > 2) {
        days.innerHTML = "<div>".concat(t.days[0], "</div><div>").concat(t.days[1], "</div><div>").concat(t.days[2], "</div>");
      } else {
        days.innerHTML = "<div>".concat(t.days[0], "</div><div>").concat(t.days[1], "</div>");
      }

      hours.innerHTML = "<div>".concat(t.hours[0], "</div><div>").concat(t.hours[1], "</div>");
      minutes.innerHTML = "<div>".concat(t.minutes[0], "</div><div>").concat(t.minutes[1], "</div>");
      seconds.innerHTML = "<div>".concat(t.seconds[0], "</div><div>").concat(t.seconds[1], "</div>");
